// Jamgan di recode bang
// Thanks For Real Author
// Contact 089686527295
#include <iostream>   
#include <iostream>  
#include <windows.h>
#include <conio.h>
...
int main()
{
 ...
 float fSpk = 0;
  ...
  {
    system("cls");
    tulisTengah("GAME BALAP By Achmad Sofyan H", 10);// Jangan diganti Author Nya COK
    tulisTengah("==============================", 11);
  ...
  system("cls");
    ...
    tulisTengah("==============================================================", 16);
    tulisTengah("Coded By : Achmad Sofyan & Dimas Aditya : gihub.com/ashcoders.", 17);
    tulisTengah("==============================================================", 20);
    tidur(5000);
    getch();
